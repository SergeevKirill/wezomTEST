...
/* harmony import */ var jquery_mmenu__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! jquery.mmenu */ "./node_modules/jquery.mmenu/dist/jquery.mmenu.all.js");
/* harmony import */ var jquery_mmenu__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(jquery_mmenu__WEBPACK_IMPORTED_MODULE_3__);
...
/* harmony import */ var _js_components_popup__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../js/components/popup */ "./resources/js/components/popup.js");
/* harmony import */ var _js_components_popup__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(_js_components_popup__WEBPACK_IMPORTED_MODULE_7__);
/* harmony import */ var _js_components_shows_slides__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../js/components/shows-slides */ "./resources/js/components/shows-slides.js");
/* harmony import */ var _js_components_menu__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../js/components/menu */ "./resources/js/components/menu.js");
/* harmony import */ var _js_components_menu__WEBPACK_IMPORTED_MODULE_9___default = /*#__PURE__*/__webpack_require__.n(_js_components_menu__WEBPACK_IMPORTED_MODULE_9__);
/* harmony import */ var _js_components_resize__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../js/components/resize */ "./resources/js/components/resize.js");
/* harmony import */ var _js_components_resize__WEBPACK_IMPORTED_MODULE_10___default = /*#__PURE__*/__webpack_require__.n(_js_components_resize__WEBPACK_IMPORTED_MODULE_10__);
/* harmony import */ var _js_components_values__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../js/components/values */ "./resources/js/components/values.js");
/* harmony import */ var _js_components_values__WEBPACK_IMPORTED_MODULE_11___default = /*#__PURE__*/__webpack_require__.n(_js_components_values__WEBPACK_IMPORTED_MODULE_11__);
/* harmony import */ var _js_components_forms__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../js/components/forms */ "./resources/js/components/forms.js");
/* harmony import */ var _js_components_cart__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../js/components/cart */ "./resources/js/components/cart.js");
/* harmony import */ var _js_components_cart__WEBPACK_IMPORTED_MODULE_13___default = /*#__PURE__*/__webpack_require__.n(_js_components_cart__WEBPACK_IMPORTED_MODULE_13__);
/* harmony import */ var _js_components_filter__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../js/components/filter */ "./resources/js/components/filter.js");
/* harmony import */ var _js_components_filter__WEBPACK_IMPORTED_MODULE_14___default = /*#__PURE__*/__webpack_require__.n(_js_components_filter__WEBPACK_IMPORTED_MODULE_14__);
/* harmony import */ var _js_components_maps__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../js/components/maps */ "./resources/js/components/maps.js");
...
/* harmony import */ var _js_components_script__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ../js/components/script */ "./resources/js/components/script.js");
...
$(function () {
  var filterShowOption = $('.filter-option-show');
  var filterShowOptionIcon = $('.filter-option-show__icon');
  var filterOptionSlide = $('.filter-option-slide');
...
$(function () {
  ...
  var subscribeForm = $('.form-flex');
  var commentStar = $('.comment-star');
  var formsSelect = $('.forms__select');
  var rangeSlider = $('.js-range-slider');
  var filterPrice = $('.filter-price__input');
  var cartInput = $('.cart-item .table-input');
  ...
  function separateZero(value) {
    var result = value.replace(/\s/g, '').replace(/\B(?=(\d{3})+(?!\d))/g, ' ');
    return result;
  }

  function checkAndUpdateRange($minElement, $maxElement, $range, stringTransform, isFirst) {
    var minRange = $minElement.val();
    var minValue = $minElement.attr('min');
    var maxRange = $maxElement.val();
    var maxValue = $maxElement.attr('max');
  ...
  if (rangeSlider[0]) {
    rangeSlider.ionRangeSlider({
      ...
      onChange: function onChange() {
        var splitTarget = rangeSlider.val();
        var splitData = splitTarget.split(/;/, 2);
    ...
    var myRange = rangeSlider.data('ionRangeSlider');
    var minInput = filterPrice.eq(0);
    var maxInput = filterPrice.eq(1);
  ...
  if ($(formsSelect)[0]) {
    ...
    formsSelect.on('select2:select', function () {
      ...
      var newPrice = $('.item-price--new', '.buy__wrapper');
      var oldPrice = $('.item-price--old', '.buy__wrapper');
      var inStock = $('.quantity__in-stock', '.buy__wrapper');
  ...
  var subscribeButton = $('.sub-button');
  ...
  if (commentStar[0]) {
    commentStar.hover(function () {
      var elIndex = commentStar.index(this);
    ...
    commentStar.click(function () {
      ...
      var active = elIndex + 1;

      for (var e = 4; active <= e; active++) {
        commentStar.eq(active).removeClass('comment-active-star');
      }

      var activeStars = $('.input-stars');
      activeStars.val(elIndex + 1);
      var activeStarsCount = parseInt(activeStars.val());
...
$(function () {
  if ($('.js-google-map')[0]) {
    var initMap = function initMap() {
      ...
      mapChangeButton.each(function () {
        ...
        google.maps.event.addListener(marker, 'click', function () {
          ...
          var address = options.address_country + "<br>" + options.address_local;
      ...
      for (var _i = 0; _i < markers.length; _i++) {
        bounds.extend(markers[_i].getPosition());
      }
    ...
    var map;
    var mapChangeButton = $('.js-google-map-change-destination');
    var resetButton = $('.js-reset-map');
    initMap();
...
$(function () {
  if ($('#my-menu')) {
    var $menu = $('#my-menu').mmenu({
      ...
      'iconbar': {
        'add': true,
        'bottom': ['<a href="#" class="social-media__link"><svg class="social-media__image"><use xlink:href="sprite/sprite.svg#sprite-vk"></use></svg></a>', '<a href="#" class="social-media__link"><svg class="social-media__image"><use xlink:href="sprite/sprite.svg#sprite-facebook-footer"></use></svg></a>', '<a href="#" class="social-media__link"><svg class="social-media__image"><use xlink:href="sprite/sprite.svg#sprite-twitter-1"></use></svg></a>', '<a href="#" class="social-media__link"><svg class="social-media__image"><use xlink:href="sprite/sprite.svg#sprite-youtube"></use></svg></a>']
      }
    });
    var $menuOpenButton = $('#mmenu_open');
...
/***/ "./resources/js/components/resize.js":
/*!*******************************************!*\
  !*** ./resources/js/components/resize.js ***!
  \*******************************************/
/*! no static exports found */
...
/***/ "./resources/js/components/script.js":
/*!*******************************************!*\
  !*** ./resources/js/components/script.js ***!
  \*******************************************/
/*! no exports provided */
...
/***/ "./resources/js/components/shows-slides.js":
/*!*************************************************!*\
  !*** ./resources/js/components/shows-slides.js ***!
  \*************************************************/
/*! no exports provided */
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(function () {
  var dropdownTarget = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.js-dropdown-target');
  var dropdownButton = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.js-dropdown');

  if (dropdownTarget[0]) {
    if (jquery__WEBPACK_IMPORTED_MODULE_0___default()('body').hasClass('item-page')) {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.path-link', '.cart__wrapper').click(function () {
    jquery__WEBPACK_IMPORTED_MODULE_0___default.a.magnificPopup.close();
  });
  var scrollToAnchorButton = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.anchor-scroll');
  ...
  var itemTabButton = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.item-tabs__button');
  ...
  if (window.location.hash) {
    ...
    for (var i = 0; i < itemTabButton.length; i++) {
      itemTabButton.eq(i).removeClass('is-active');
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.my-block').eq(i).removeClass('is-active');

      if (i === 2) {
        itemTabButton.eq(i).addClass('is-active');
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('.my-block').eq(i).addClass('is-active');
      }
    }
  }

  if (jquery__WEBPACK_IMPORTED_MODULE_0___default()('.item__reviews-review.anchor-scroll')[0]) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.item__reviews-review.anchor-scroll').click(function () {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.my-button').data({
        "ws-block": "3",
        "ws-group": "group-h"
      }).addClass('is-active');
    });
  ...
  var slideDownButton = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.slide-down');

  if (slideDownButton[0]) {
    slideDownButton.click(function () {
      var target = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.slide-target').eq(jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).data('slide-button') - 1);

      if (target.css('max-height') === '1500px') {
        target.removeAttr('style');
        jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).text('Показать все');
      } else {
        target.css('max-height', '1500px');
        jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).text('Скрыть часть');
      }
    });
  }

  var showFilterButton = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.filter-show');

  if (showFilterButton[0]) {
    showFilterButton.click(function () {
      var filter = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.filter__wrapper');
      var buttonText = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.filter-show .filter-show-text');
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.arrow-spin').toggleClass('rotate');

      if (filter.css('max-height') === '1500px') {
        filter.attr('style', '');
        jquery__WEBPACK_IMPORTED_MODULE_0___default()(buttonText).text('Показать фильтр');
        showFilterButton.removeClass('is-active');
      } else {
        filter.css('max-height', '1500px');
        jquery__WEBPACK_IMPORTED_MODULE_0___default()(buttonText).text('Скрыть фильтр');
...
/***/ "./resources/js/components/values.js":
/*!*******************************************!*\
  !*** ./resources/js/components/values.js ***!
  \*******************************************/
/*! no static exports found */
...
$(function () {
  if ($('.price', 'tr')[0]) {
    $('.price', 'tr').each(function () {
      var curIndex = $('.price', 'tr').index(this);
      var currentPrice = parseInt($(this).text().replace(/\s/g, ''));
      $('.price-change').eq(curIndex).change(function () {
        var multiplier = $(this).val();
        var newPrice;
        var maxValue = $(this).attr('max').toString().replace(/\B(?=(\d{3})+(?!\d))/g, ' ');
        var minValue = $(this).attr('min').toString().replace(/\B(?=(\d{3})+(?!\d))/g, ' ');
  ...
  var cartItemPrice = $('.item-price--new--digits', '.cart-item__total-price ');

  if (cartItemPrice[0]) {
    cartItemPrice.each(function () {
      var divIndex = cartItemPrice.index(this);
      var startPrice = parseInt(cartItemPrice.eq(divIndex).text().replace(/\s/g, ''));
      var tableInput = $('.table-input', '.cart-item ');
      var multiplierStart = parseInt(tableInput.eq(divIndex).val());
      var calculatedStart = multiplierStart * startPrice;
      var pricesStart = [];
      ...
      var summStart = pricesStart.reduce(reducer);
      $('.item-price--new--digits', '.cart__lower').text(summStart.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ' '));
      $('.increment').eq(divIndex).click(function () {
        var input = $(this).siblings('.table-input');
        var inputValue = input.val();
        var inputNumber = parseInt(inputValue.substr(0, inputValue.indexOf(' ')));
        inputNumber++;
      ...
      tableInput.eq(divIndex).change(function () {
        var tableInput = $('.table-input', '.cart-item');
        var index = tableInput.index(this);
        var multiplier = parseInt(tableInput.eq(index).val());
        var tableInputMax = tableInput.eq(index).attr('max');
        var tableInputMin = tableInput.eq(index).attr('min');
        ...
        var calculated = startPrice * multiplier;
        cartItemPrice.eq(index).text(calculated.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ' '));
        var prices = [];

        for (var _i = 0; _i < tableInput.length; _i++) {
          prices[_i] = parseInt(cartItemPrice.eq(_i).text().replace(/\s/g, ''));
        }
        ...
        var summ = prices.reduce(reducer);
...
/***/ 0:
/*!**********************************************************************************************************************!*\
  !*** multi ./resources/js/app.js ./resources/sass/app.scss ./resources/sass/fonts.scss ./resources/sass/vendor.scss ***!
  \**********************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! C:\OpenServer\OSPanel\domains\testWezom\resources\js\app.js */"./resources/js/app.js");
__webpack_require__(/*! C:\OpenServer\OSPanel\domains\testWezom\resources\sass\app.scss */"./resources/sass/app.scss");
__webpack_require__(/*! C:\OpenServer\OSPanel\domains\testWezom\resources\sass\fonts.scss */"./resources/sass/fonts.scss");
module.exports = __webpack_require__(/*! C:\OpenServer\OSPanel\domains\testWezom\resources\sass\vendor.scss */"./resources/sass/vendor.scss");
