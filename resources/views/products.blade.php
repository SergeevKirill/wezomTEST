<section class="products @yield('similarClass') content centered">
    <div class="section-title__wrapper @yield('similarClass')">
        <h1 class="section-title @yield('similarClass')">
            {{$title}}
        </h1>
        <a href="{{url('catalog')}}" class="section-title__redirect-link">
            <span class="underline">Ссылка в каталог</span><span class="arrow">&#x2192;</span>
        </a>
    </div>
        ...
        @foreach($mock->items as $item)
            <div class="item__wrapper">
                ...
                <div class="item-title__wrapper">
                    <a href="{{url('item')}}" data-ws-group="group-h" data-ws-button="3" class="item-title">
                ...
                <div class="item-buy-button__wrapper @yield('similarClass')">
                    <span class="@yield('similarClass') item-quantity">
                        <input type="number" class="table-input" min="1" value="4" max="20"> шт.
                    </span>
                    <button data-mfp-src="#cart" data-effect="mfp-fadeout" class="button--gradient button-buy item-buy-button cart-open open">
                ...
                <div class="item-bottom-button__wrapper">
                    <a href="#" class="item-bottom-button">
                        ...
                        <span class="item-bottom-button__text">Сравнить товар</span>
                    </a>
                    <a href="#" class="item-bottom-button">
                        <svg class="item-bottom-button__favourites-img">
                            <use xlink:href="sprite/sprite.svg#sprite-favourite"></use>
                        </svg>
                        <span class="item-bottom-button__text">В избранное</span>
                    </a>
                </div>
            </div>
        @endforeach
